...
<body>
    <form method ="POST"action="#" style="border:1px solid #ccc">
        <div class="container">
          ...
          <label for="email"><b>hindi sc quetion</b></label>
          <input type="text" placeholder="enter hindi sc quesstion" name="question" >
...
$query="INSERT INTO scgk  VALUES('$total2','$question','$optiona','$optionb','$optionc', '$optiond', '$optionno','$answer','$english_question')";
