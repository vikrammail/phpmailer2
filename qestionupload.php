...
<body>
    <form method ="POST"action="#" style="border:1px solid #ccc">
        <div class="container">
          ...
          <label for="email"><b>quation</b></label>
          <input type="text" placeholder="enter quesstion" name="question" >
...
if($question == "" || $optiona == '' || $optionb == '' || $optionc == '' || $optiond == '' || $optionno == '' || $answer == ''){
...
$query="INSERT INTO quiz3  VALUES('$total2','$question','$optiona','$optionb','$optionc', '$optiond', '$optionno','$answer')";
