...
<html>
    <head>
        ...
        <meta name="description" content="here are most usefull links">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <link rel="stylesheet" href="">
        <meta name="keywords" content=" usefull links,letest corentaffairs, items,item,web-hub,web,usefull links,amazing links,educational links,quiz ,questionns">
...
$query = "SELECT * FROM links  where link_code = 'u' ";
